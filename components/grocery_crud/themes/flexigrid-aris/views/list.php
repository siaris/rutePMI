		...
		<thead>
			<tr class='hDiv'>
				...
				<th width='<?php echo $column_width?>%'>
					<div class="text-left <?php if(!in_array($column->field_name,$unset_columns_order)){?>field-sorting <?php if(isset($order_by[0]) &&  $column->field_name == $order_by[0]){?><?php echo $order_by[1]?><?php }?><?php }?>" rel='<?php echo $column->field_name?>'>
