<?php
	$this->set_css($this->default_theme_path.'/flexigrid-aris/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/flexigrid-aris/js/cookies.js');
	$this->set_js($this->default_theme_path.'/flexigrid-aris/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/flexigrid-aris/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/flexigrid-aris/js/jquery.printElement.min.js');
...
<script type='text/javascript'>
    ...
    var table_title= '<?= isset($table_title) ? $table_title : ''?>';
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			...
			<select name="search_field" id="search_field">
				...
				<?php if(!in_array($column->field_name,$unset_columns_filter)){?>
