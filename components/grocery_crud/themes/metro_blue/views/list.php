...
function delete_selected()
{
	...
	//send data to delete
	$base_url = <?= base_url();?>
	$.post('<?= site_url('master/perkiraan/delete_all_kelompok');?>', { selection: list }, function(data) {
		alert('Voila!');
	});
}
</script>
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				?>
						<a href="<?php echo $action_url; ?>" class="edit_button ui-button ui-widget ui-state-tombol ui-corner-all ui-button-text-icon-primary" role="button">
				...
				?>
				<?php if(!$unset_read){?>
					<a href="<?php echo $row->read_url?>" class="edit_button ui-button ui-widget ui-state-tombol ui-corner-all ui-button-text-icon-primary" role="button">
				...
				<?php if(!$unset_edit){?>
					<a href="<?php echo $row->edit_url?>" class="edit_button ui-button ui-widget ui-state-tombol ui-corner-all ui-button-text-icon-primary" role="button">
				...
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						href="javascript:void(0)" class="delete_button ui-button ui-widget ui-state-tombol ui-corner-all ui-button-text-icon-primary" role="button">
