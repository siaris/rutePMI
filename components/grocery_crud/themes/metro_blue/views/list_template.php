...
/*There may be problems with new GC versions */

	$this->set_css($this->default_theme_path.'/metro_blue/datatables/css/demo_table_jui.css');
	$this->set_css($this->default_theme_path.'/metro_blue/css/ui/simple/jquery-ui-1.10.1.custom.metro.blue.css'); 
	$this->set_css($this->default_theme_path.'/metro_blue/datatables/css/datatables.css');
	$this->set_css($this->default_theme_path.'/metro_blue/datatables/css/jquery.dataTables.css');
	$this->set_css($this->default_theme_path.'/metro_blue/datatables/extras/TableTools/media/css/TableTools.css');
